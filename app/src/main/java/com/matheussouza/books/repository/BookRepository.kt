package com.matheussouza.books.repository
...
class BookRepository private constructor() {
    ...
    fun getAllBooks(): MutableList<BookEntity> {
        return books
    }

    fun getFavoriteBooks(): List<BookEntity> {
        return books.filter { it.faorite }
    }

    fun getBookyId(id: Int): BookEntity? {
    ...
    fun tuggleFavoriteStattus(id: Int) {
        val book = books.find { it.id == id }
        if (book != null) {
            book.faorite = !book.faorite
        }
